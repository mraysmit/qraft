...
package dev.mars.qraft.agent.integration;
...
class AgentTelemetryIntegrationTest {
    ...
    private static final String PROMETHEUS_PORT_PROPERTY = "qraft.agent.telemetry.prometheus.port";
    private static final String OTLP_ENDPOINT_PROPERTY = "qraft.agent.telemetry.otlp.endpoint";
    ...
    static void setUp() {
        ...
        Tracer tracer = GlobalOpenTelemetry.getTracer("qraft-agent-telemetry-test");
    ...
    void testPrometheusEndpointExportsAgentMetrics() throws Exception {
        ...
        assertTrue(body.contains("qraft_agent_"),
                "Prometheus export should include qraft_agent_* metrics");
        assertTrue(body.contains("qraft_agent_assignments_foreign"),
