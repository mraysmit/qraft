...
public final class AgentConfig {
    ...
    private static final String CONFIG_FILE = "qraft-agent.properties";
    ...
    public String getVersion() {
        return getString("qraft.agent.version", "1.0.0");
    }

    // ==================== Controller Connection ====================

    public String getControllerUrl() {
        return getString("qraft.agent.controller.url", "http://localhost:8080/api/v1");
    }

    // ==================== Network Configuration ====================

    public int getAgentPort() {
        return getInt("qraft.agent.port", 8080);
    }

    public String getRegion() {
        return getString("qraft.agent.region", "default");
    }

    public String getDatacenter() {
        return getString("qraft.agent.datacenter", "default");
    }

    // ==================== Transfer Configuration ====================

    public int getMaxConcurrentTransfers() {
        return getInt("qraft.agent.transfers.max-concurrent", 5);
    }

    public String getSupportedProtocols() {
        return getString("qraft.agent.protocols", "HTTP,HTTPS");
    }

    // ==================== Heartbeat Configuration ====================

    public long getHeartbeatIntervalMs() {
        return getLong("qraft.agent.heartbeat.interval-ms", 30000);
    }

    // ==================== Job Polling Configuration ====================

    public long getJobPollingInitialDelayMs() {
        return getLong("qraft.agent.jobs.polling.initial-delay-ms", 5000);
    }

    public long getJobPollingIntervalMs() {
        return getLong("qraft.agent.jobs.polling.interval-ms", 10000);
    }
    ...
    public int getForeignAssignmentMismatchThreshold() {
        return getInt("qraft.agent.security.foreign-assignment-threshold", 1);
    }

    // ==================== Telemetry Configuration ====================

    public boolean isTelemetryEnabled() {
        return getBoolean("qraft.agent.telemetry.enabled", true);
    }

    public int getPrometheusPort() {
        return getInt("qraft.agent.telemetry.prometheus.port", 9465);
    }

    public String getOtlpEndpoint() {
        return getString("qraft.agent.telemetry.otlp.endpoint", "http://localhost:4317");
    }
     ...
     * <ol>
     *   <li>Environment variable (e.g., QRAFT_AGENT_CONTROLLER_URL)</li>
     *   <li>System property (e.g., -Dqraft.agent.controller.url=...)</li>
     *   <li>Properties file (qraft-agent.properties)</li>
     *   <li>Default value</li>
     * </ol>
     */
    public String getString(String key, String defaultValue) {
        // 1. Check environment variable (QRAFT_AGENT_XXX format)
        ...
        // 2. Check system property (e.g., -Dqraft.agent.port=8090)
    ...
    private void logConfiguration() {
        logger.info("=== Qraft Agent Configuration ===");
