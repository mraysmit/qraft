 ...
 */
@FunctionalInterface
public interface LocalStatusReporter {
    /** Returns {@code false} when the check is not running and the report was discarded. */
    boolean report(CheckStatus status, String output);
}
