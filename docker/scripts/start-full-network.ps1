# Start Full Qraft Network Test Environment
...
Write-Host "=== Qraft Full Network Test Environment ===" -ForegroundColor Green
...
Write-Host "Starting Qraft network environment..." -ForegroundColor Yellow
...
try {
    ...
    Write-Host ""
    Write-Host "=== Qraft Network Started Successfully! ===" -ForegroundColor Green
    Write-Host ""
