# Qraft Log Extraction Pipeline Demo
# Shows exactly how logs flow from applications to aggregation

Write-Host "Qraft Log Extraction Pipeline Demo" -ForegroundColor Green
...
Write-Host "   │ Qraft Apps │───▶│ Docker JSON │───▶│  Promtail   │───▶│    Loki     │" -ForegroundColor White
