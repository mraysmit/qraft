# Qraft Observability Stack Startup Script
...
Write-Host "  Qraft Observability Stack Startup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
while ($waited -lt $maxWait) {
    $grafanaHealth = docker inspect --format='{{.State.Health.Status}}' qraft-grafana 2>$null
