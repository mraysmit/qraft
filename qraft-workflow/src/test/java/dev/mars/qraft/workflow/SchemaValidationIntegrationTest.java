...
class SchemaValidationIntegrationTest {
    ...
    class EndToEndValidationTests {
        ...
        void testCompleteWorkflowParsing() throws WorkflowParseException {
            ...
            assertEquals("integration@qraft.dev", metadata.getAuthor());
