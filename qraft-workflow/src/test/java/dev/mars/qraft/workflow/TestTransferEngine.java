...
package dev.mars.qraft.workflow;
...
class TestTransferEngine implements TransferEngine {
    ...
    @Override
    public dev.mars.qraft.monitoring.TransferEngineHealthCheck getHealthCheck() {
        return dev.mars.qraft.monitoring.TransferEngineHealthCheck.builder()
                .up()
    ...
    @Override
    public dev.mars.qraft.monitoring.TransferMetrics getProtocolMetrics(String protocolName) {
        return new dev.mars.qraft.monitoring.TransferMetrics(protocolName);
    }

    @Override
    public java.util.Map<String, dev.mars.qraft.monitoring.TransferMetrics> getAllProtocolMetrics() {
