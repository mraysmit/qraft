 ...
 * 
 * The Prometheus port is read from configuration (qraft.telemetry.prometheus.port),
 * defaulting to 9464.
 *
    ...
    public void handle(RoutingContext ctx) {
        webClient.get(prometheusPort, "localhost", "/metrics")
                ...
                .onFailure(err -> {
                    ...
                    ctx.fail(new dev.mars.qraft.controller.http.QraftApiException(
                            dev.mars.qraft.controller.http.ErrorCode.SERVICE_UNAVAILABLE,
