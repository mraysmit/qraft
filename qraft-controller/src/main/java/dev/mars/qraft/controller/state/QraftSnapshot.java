...
public class QraftSnapshot implements Serializable {
    ...
    public QraftSnapshot() {
        this.timestamp = Instant.now();
    }

    @JsonCreator
    public QraftSnapshot(@JsonProperty("agents") Map<String, AgentInfo> agents,
