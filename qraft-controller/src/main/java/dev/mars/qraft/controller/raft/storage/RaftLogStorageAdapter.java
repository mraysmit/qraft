...
/**
 * Adapter that bridges the external {@code raftlog-core} library to Qraft's
 ...
 * API to Vert.x {@link Future} for seamless integration with Qraft.</p>
 *
 * <p><b>Why an Adapter?</b></p>
 * <ul>
 *   <li>The {@code raftlog-core} library uses {@code CompletableFuture} (standard Java)</li>
 *   <li>Qraft uses Vert.x {@code Future} for reactive patterns</li>
...
public final class RaftLogStorageAdapter implements RaftStorage {
    ...
    public Future<Void> appendEntries(List<LogEntryData> entries) {
        ...
        // Convert Qraft LogEntryData to raftlog LogEntryData
