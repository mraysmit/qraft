 ...
 *   <li><b>file</b> - Custom WAL implementation (Qraft-internal)</li>
 ...
 * or environment variable {@code qraft.raft.storage.type}.</p>
 *
...
public final class RaftStorageFactory {
    ...
    public enum StorageType {
        ...
        RAFTLOG,
        /** Custom WAL implementation (Qraft-internal) */
        FILE,
     ...
     * <ol>
     *   <li>System property {@code qraft.raft.storage.type}</li>
     *   <li>Environment variable {@code QRAFT_RAFT_STORAGE_TYPE}</li>
    ...
    private static String getConfiguredStorageType() {
        ...
        String type = System.getProperty("qraft.raft.storage.type");
        if (type != null && !type.isBlank()) {
            return type.trim();
        }

        // Check environment variable
        type = System.getenv("QRAFT_RAFT_STORAGE_TYPE");
        if (type != null && !type.isBlank()) {
            return type.trim();
        }
