 ...
 * <ul>
 *   <li>qraft.raft.threadpool.active (gauge) - Currently active threads in Raft I/O pool</li>
 *   <li>qraft.raft.threadpool.queued (gauge) - Tasks waiting in queue</li>
 *   <li>qraft.raft.threadpool.completed (counter) - Total completed tasks</li>
 *   <li>qraft.raft.threadpool.pool_size (gauge) - Current pool size</li>
 *   <li>qraft.raft.rpc.vote_requests (counter) - Vote requests sent</li>
 *   <li>qraft.raft.rpc.append_entries (counter) - AppendEntries RPCs sent</li>
 * </ul>
 *
...
public class RaftMetrics {
    ...
    private static final String METER_NAME = "qraft-controller-raft";
    ...
    private RaftMetrics() {
        ...
        // Initialize counters
        voteRequestsCounter = meter.counterBuilder("qraft.raft.rpc.vote_requests")
                .setDescription("Total number of vote requests sent")
                .setUnit("1")
                .build();

        appendEntriesCounter = meter.counterBuilder("qraft.raft.rpc.append_entries")
                .setDescription("Total number of AppendEntries RPCs sent")
                .setUnit("1")
                .build();

        completedTasksCounter = meter.counterBuilder("qraft.raft.threadpool.completed")
                .setDescription("Total completed tasks in Raft I/O thread pool")
                .setUnit("1")
                .build();

        // Initialize gauges
        meter.gaugeBuilder("qraft.raft.threadpool.active")
        ...
        meter.gaugeBuilder("qraft.raft.threadpool.queued")
        ...
        meter.gaugeBuilder("qraft.raft.threadpool.pool_size")
