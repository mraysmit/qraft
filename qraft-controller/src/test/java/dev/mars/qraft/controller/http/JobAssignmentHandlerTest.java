...
/**
 * Tests for {@link dev.mars.qraft.controller.http.handlers.JobAssignmentHandler}.
 *
...
class JobAssignmentHandlerTest {
    ...
    static void setUp() throws Exception {
        ...
        raftNode = RaftNode.builder().vertx(vertx).nodeId("assign-test-node").clusterNodes(clusterNodes).transport(transport).stateMachine(stateMachine).mode(RaftNodeMode.volatileMode()).commandCodec(new ProtobufRaftCommandCodec())
