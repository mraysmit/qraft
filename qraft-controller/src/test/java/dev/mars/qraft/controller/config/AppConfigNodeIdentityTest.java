...
class AppConfigNodeIdentityTest {
    ...
    void getStringPrecedenceOrder() {
        ...
        String testKey = "qraft.test.precedence.check";
        String defaultValue = "default-value";
        
        // Should return default when nothing is set
        String result = config.getString(testKey, defaultValue);
        
        // Environment variable would be QRAFT_TEST_PRECEDENCE_CHECK
        String envValue = System.getenv("QRAFT_TEST_PRECEDENCE_CHECK");
    ...
    void multiNodeClusterDetection() {
        ...
        // A multi-node cluster is when qraft.cluster.nodes contains a comma
