...
class ErrorResponseTest {
    ...
    // ==================== QraftApiException Tests ====================

    @Nested
    @DisplayName("QraftApiException")
    class QraftApiExceptionTests {

        @Test
        @DisplayName("notFound factory creates 404 exception")
        void testNotFoundFactory() {
            QraftApiException ex = QraftApiException.notFound(
                ErrorCode.TRANSFER_NOT_FOUND, 
                "job-999"
            );
        ...
        void testBadRequestFactory() {
            QraftApiException ex = QraftApiException.badRequest(
        ...
        void testNotLeaderFactory() {
            QraftApiException ex = QraftApiException.notLeader("node-2");
        ...
        void testNoLeaderFactory() {
            QraftApiException ex = QraftApiException.noLeader();
        ...
        void testInternalFactory() {
            ...
            QraftApiException ex = QraftApiException.internal(
