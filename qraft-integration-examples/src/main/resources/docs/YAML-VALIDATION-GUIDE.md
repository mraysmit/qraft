# Qraft YAML Schema Validation Guide

## Overview

Qraft now includes a comprehensive YAML schema validation system that ensures workflow definitions are consistent, complete, and follow best practices. This guide covers the new validation features, requirements, and migration from legacy formats.
...
All Qraft workflow YAML files must now include a complete metadata section with the following required fields:
...
The new YAML schema validation system ensures consistency, completeness, and best practices across all Qraft workflows. By following this guide, you can create robust, maintainable workflow definitions that integrate seamlessly with the Qraft platform.
