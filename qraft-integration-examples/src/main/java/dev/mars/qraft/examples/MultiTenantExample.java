...
import dev.mars.qraft.tenant.model.Tenant;
import dev.mars.qraft.tenant.model.TenantConfiguration;
import dev.mars.qraft.tenant.model.ResourceUsage;
import dev.mars.qraft.tenant.service.SimpleTenantService;
import dev.mars.qraft.tenant.service.SimpleResourceManagementService;
import dev.mars.qraft.tenant.service.TenantService;
import dev.mars.qraft.tenant.service.ResourceManagementService;
...
/**
 * Multi-Tenant Example - Demonstrates Qraft multi-tenant capabilities.
 * 
 * This example shows:
 ...
 * 
 * Run with: mvn exec:java -Dexec.mainClass="dev.mars.qraft.examples.MultiTenantExample" -pl qraft-integration-examples
 * 
...
public class MultiTenantExample {
    ...
    public static void main(String[] args) {
        log.exampleStart("Qraft Multi-Tenant Example",
