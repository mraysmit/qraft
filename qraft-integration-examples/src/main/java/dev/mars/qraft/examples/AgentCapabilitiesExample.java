...
/**
 * Agent Capabilities Example - Demonstrates Qraft agent capability configuration and matching.
 * 
 ...
 * 
 * Agent capabilities are key to intelligent job routing in Qraft, ensuring
 * that file transfers are assigned to agents that can handle them efficiently.
 * 
 * Run with: mvn exec:java -Dexec.mainClass="dev.mars.qraft.examples.AgentCapabilitiesExample" -pl qraft-integration-examples
 * 
