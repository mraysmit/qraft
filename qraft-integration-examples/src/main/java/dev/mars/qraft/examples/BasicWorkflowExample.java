...
import dev.mars.qraft.workflow.*;
...
/**
 * Basic example demonstrating YAML workflow execution with the Qraft transfer engine.
...
public class BasicWorkflowExample {
    ...
    private String createSampleWorkflow() {
        return """
                ...
                metadata:
                  ...
                  description: Basic demonstration of Qraft workflow capabilities
                  labels:
    ...
    private Path createTempDirectory() throws Exception {
        Path tempDir = Paths.get(System.getProperty("java.io.tmpdir"), "qraft-demo");
