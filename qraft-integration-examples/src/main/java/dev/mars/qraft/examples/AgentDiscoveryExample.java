...
/**
 * Agent Discovery Example - Demonstrates Qraft agent discovery and fleet management.
 * 
 ...
 * 
 * In production, this would connect to the Qraft API service which maintains
 * a distributed agent registry using Raft consensus.
 * 
 * Run with: mvn exec:java -Dexec.mainClass="dev.mars.qraft.examples.AgentDiscoveryExample" -pl qraft-integration-examples
 * 
