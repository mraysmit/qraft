...
import dev.mars.qraft.network.ConnectionPoolService;
import dev.mars.qraft.network.NetworkTopologyService;
 ...
 * 
 * Run with: mvn exec:java -Dexec.mainClass="dev.mars.qraft.examples.EnterpriseProtocolExample" -pl qraft-integration-examples
 * 
...
public class EnterpriseProtocolExample {
    ...
    public static void main(String[] args) {
        log.exampleStart("Qraft Enterprise Protocol Example",
