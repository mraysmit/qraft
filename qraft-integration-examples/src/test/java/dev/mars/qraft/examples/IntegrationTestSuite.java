...
import dev.mars.qraft.protocol.ProtocolFactory;
import dev.mars.qraft.protocol.TransferProtocol;
...
import dev.mars.qraft.tenant.service.TenantService.TenantServiceException;
import dev.mars.qraft.transfer.SimpleTransferEngine;
import dev.mars.qraft.workflow.SimpleWorkflowEngine;
import dev.mars.qraft.workflow.WorkflowDefinition;
import dev.mars.qraft.workflow.YamlWorkflowDefinitionParser;
    ...
    void testWorkflowWithMultipleProtocols() throws Exception {
        String workflowYaml = """
                metadata:
                  ...
                  author: "Qraft Integration Test Suite"
