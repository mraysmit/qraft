...
class SftpTransferProtocolTest {
    ...
    // Error handling tests moved to dev.mars.qraft.protocol.errorhandling.SftpTransferProtocolErrorHandlingTest
    
    // Additional error handling tests moved to dev.mars.qraft.protocol.errorhandling.SftpTransferProtocolErrorHandlingTest
    ...
    // Additional edge case error tests moved to dev.mars.qraft.protocol.errorhandling.SftpTransferProtocolErrorHandlingTest
