...
import dev.mars.qraft.testing.ExpectsError;
...
class FtpTransferProtocolTest {
    ...
    void setUp() {
        ...
        TransferRequest dummyRequest = TransferRequest.builder()
                ...
                .build();
        context = new TransferContext(new dev.mars.qraft.core.TransferJob(dummyRequest));
    }
    ...
    // Error handling tests moved to dev.mars.qraft.protocol.errorhandling.FtpTransferProtocolErrorHandlingTest
    ...
    // Additional error handling tests moved to dev.mars.qraft.protocol.errorhandling.FtpTransferProtocolErrorHandlingTest
    ...
    // Additional edge case error tests moved to dev.mars.qraft.protocol.errorhandling.FtpTransferProtocolErrorHandlingTest
}
